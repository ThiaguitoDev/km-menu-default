...
(function() {
    ...
    window.ESX_MENU = {};
    ESX_MENU.ResourceName = 'qb-menu-default';
    ESX_MENU.opened = {};
    ESX_MENU.focus = [];
    ESX_MENU.pos = {};
    ...
    ESX_MENU.render = function() {
        ...
        //$(".menu.align-bottom-right:last").css('transform','perspective(400px) rotateY('+localStorage.getItem("deg")+'deg)');;
        ...
        /*
        	...
        	$("body").off('mousemove').on('mousemove', function (e) {
        			...
        			$(".align-bottom-right").css('transform','perspective(400px) rotateY('+deg+'deg)');
        	});*/
